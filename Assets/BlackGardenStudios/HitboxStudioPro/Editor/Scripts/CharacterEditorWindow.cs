        ...
        void OnGUI()
        {
            ...
            if (hitboxManager != null && (renderer = target.GetComponentInChildren<SpriteRenderer>()) != null)
            {
                ...
                if (character != null)
                {
                    ...
                    RenderSprite(renderer, palette == null ? null : palette, previewPaletteIndex);
                }
            }
            ...
            if (GUILayout.Button("Collision Matrix", GUILayout.Width(100f)))
                HitboxCollisionMatrixEditorWindow.Init();
